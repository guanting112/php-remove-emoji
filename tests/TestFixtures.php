...
class TestFixtures
{
    public const EMOJI_15_DATA = <<<'EOT'
...
EOT;
    ...
    public const EMOJI_13_1_DATA = <<<'EOT'
...
🧑🏾‍❤️‍💋‍🧑🏾 E13.1 kiss: person, person, medium-dark skin tone
🧑🏾‍❤‍💋‍🧑🏾 E13.1 kiss: person, person, medium-dark skin tone
...
🧑🏿‍❤️‍💋‍🧑🏿 E13.1 kiss: person, person, dark skin tone
🧑🏿‍❤‍💋‍🧑🏿 E13.1 kiss: person, person, dark skin tone
...
EOT;
    ...
    public const EMOJI_13_BETA_DATA = <<<'EOT'
[[["😀"],["😃"],["😄"],["😁"],["😆"],["😅"],["🤣"],["😂"],["🙂"],["🙃"],["😉"],["😊"],["😇"],["🥰"],["😍"],["🤩"],["😘"],["😗"],["☺️"],["☺"],["😚"],["😙"],["🥲"],["😋"],["😛"],["😜"],["🤪"],["😝"],["🤑"],["🤗"],["🤭"],["🤫"],["🤔"],["🤐"],["🤨"],["😐"],["😑"],["😶"],["😏"],["😒"],["🙄"],["😬"],["🤥"],["😌"],["😔"],["😪"],["🤤"],["😴"],["😷"],["🤒"],["🤕"],["🤢"],["🤮"],["🤧"],["🥵"],["🥶"],["🥴"],["😵"],["🤯"],["🤠"],["🥷"],["🥳"],["🥸"],["😎"],["🤓"],["🧐"],["😕"],["😟"],["🙁"],["☹️"],["☹"],["😮"],["😯"],["😲"],["😳"],["🥺"],["😦"],["😧"],["😨"],["😰"],["😥"],["😢"],["😭"],["😱"],["😖"],["😣"],["😞"],["😓"],["😩"],["😫"],["🥱"],["😤"],["😡"],["😠"],["🤬"],["😈"],["👿"],["💀"],["☠️"],["☠"],["💩"],["🤡"],["👹"],["👺"],["👻"],["👽"],["👾"],["🤖"],["😺"],["😸"],["😹"],["😻"],["😼"],["😽"],["🙀"],["😿"],["😾"],["🙈"],["🙉"],["🙊"],["💋"],["💌"],["💘"],["💝"],["💖"],["💗"],["💓"],["💞"],["💕"],["💟"],["❣️"],["❣"],["💔"],["❤️"],["❤"],["🧡"],["💛"],["💚"],["💙"],["💜"],["🤎"],["🖤"],["🤍"]]]
EOT;

    public const EMOJI_11_DATA = <<<'EOT'
...
EOT;
    ...
    public const JAPANESE_DATA = <<<'EOT'
== Sample Text for Test Program ==
...
EOT;
    ...
    public const SIMPLIFIED_DATA = <<<'EOT'
简体用语编辑
...
EOT;
    ...
    public const BENCHMARK_DATA = <<<'EOT'
    == Sample Text for Test Program ==
    「にっぽん」、「にほん」と読まれる。どちらも多く用いられているため、
    日本政府は正式な読み方をどちらか一方には定めておらず、どちらの読みで
    も良いとしている[5]。
...
EOT;
    ...
    public const COMMON_SYMBOLS_DATA = <<<'EOT'
...‼⁉™↔↕↖↗↘↙↩↪⌚⌛⌨⏏⏩⏪⏫⏬⏭⏮⏯⏰⏱⏲
⏳⏸⏹⏺Ⓜ▪▫▶◀◻◼◽◾☀☁☂☃☄☎☑☔☕☘☝☠☢☣☦☪☮☯☸
☹☺♀♂♈♉♊♋♌♍♎♏♐♑♒♓♠♣♥♦♨♻♿⚒⚓⚔⚕⚖⚗⚙⚛
⚜⚠⚡⚪⚫⚰⚱⚽⚾⛄⛅⛈⛎⛏⛑⛓⛔⛩⛪⛰⛱⛲⛳⛴⛵⛷⛸
...
EOT;
    ...
    public const EMOJI_FLAGS_DATA = <<<'EOT'
...
🇦🇺🇨🇦🇨🇭🇨🇳🇩🇪🇪🇸🇫🇷🇬🇧🇮🇱🇮🇹
🇯🇵🇰🇳🇰🇷🇳🇴🇳🇵🇵🇸🇶🇦🇷🇺🇸🇸🇺🇸
🏳️🏴🏁🚩🏳️‍🌈🇹🇹🇹🇷🇹🇨🇨🇳🇨🇫🇧🇹🇹🇲
...
EOT;
    ...
    public const APPLE_EMOJI_DATA = <<<'EOT'
...
🚗🚓🚨🚲🚡🚅🛶💺🚏🏦🕋🏦📱⌚️🖲🕯🔮🎎🎐💌📦
📌☮️💟🔯☪️㊗️🈵🆚💯❕🔞🚷🔰⁉️⚠️💤🌐🌀▶️🔠🔣↔️↩️👁‍🗨
◽️🔲🇵🇦🏳️🏳️‍🌈🇹🇲🇹🇷🤛🤜🏼👍🏽👌☝🏼🥝🥦🌶🌽🍎
...
EOT;
    ...
    public const VARIATION_SEQUENCES_DATA = '.ℹ⌛⚠✒❤🀄🈚⌛︎⚠︎✒︎❤︎🀄︎🈚︎ℹ️⌛️⚠️✒️❤️🀄️🈚️.';

    public const FITZPATRICK_DATA = '.👦👦🏻👦🏼👦🏽👦🏾👦🏿👧👧🏻👧🏼👧🏽👧🏾👧🏿👨👨🏻👨🏼👨🏽👨🏾👨🏿👩👩🏻👩🏼👩🏽👩🏾👩🏿.';

    public const SYMBOLS_PRESERVATION_DATA = <<<'EOT'
~!@{}$%^&()_+=.'"~ \ | /?>><<:;#*
œ∑´†¥¨ˆøπ“‘«åß∂ƒ˙∆˚¬…æΩ≈ç√∫˜µ≤≥÷
『』：“｜，。？～！＠＃＄％＾＆＊（）＿＋
